...
document.addEventListener('DOMContentLoaded', () => {
    ...
    for ( let i = 0; i < mobileSubmenus.length; i++ ) {
        mobileSubmenus[ i ].addEventListener('click', () => {
            ...
            document.querySelector(`[data-id="${submenuId}"]`).classList.add( classOpen );
        });
    }

    const mobileSubmenusTitles = document.querySelectorAll('.menu_mobile-submenu h4');
