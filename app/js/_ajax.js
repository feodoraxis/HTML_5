import { plural_format_word } from './_functions.js';
        ...
        quizForm.on('submit', function(e) {
            ...
            $.ajax({
                ...
                success : function( result ) {
                    ...
                    const mainCountAnswersContainerHTML = document.createElement('div');
                    mainCountAnswersContainerHTML.classList = 'quiz-footer';

                    const mainCountAnswersHTML = document.createElement('p');
                    mainCountAnswersHTML.textContent = plural_format_word( result.general_count, [ 'голос', 'голоса', 'голосов' ] );
